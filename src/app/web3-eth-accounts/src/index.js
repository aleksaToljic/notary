...
Accounts._addAccountFunctions = function (account) {
    var _this = this;
...
Accounts.privateKeyToAccount = function privateKeyToAccount(privateKey) {
...
Accounts.hashMessage = function hashMessage(data) {
...
Accounts.sign = function sign(data, privateKey) {
...
Accounts.decrypt = function (v3Keystore, password, nonStrict) {
